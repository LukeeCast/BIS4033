...
<body>
  <main>
    ...
    <form aciton="monthlyPayment.php" method="post">
      ...
      <div id="dataInput">
        ...
        <input type="number" id="interest_amount" name="interest_amount" min="0" max="100" required oninput="this.nextElementSibling.value = this.value"><output>50</output><span>%</span><br>
      </div>
